...
目前 App 开发一组负责迭代和维护的 App 项目共计有 19 个,内部组件大概60个.业务高速增长时迭代和维护的过程中,忽略了对项目依赖的管理.
...
![应用依赖详情列表](/assets/app_deps_list.jpg)
...
![组件列表](/assets/component_list.jpg)
...
![全部依赖列表](/assets/all_deps_list.jpg)
...
![组件上传和过期版本信息上报](/assets/yk_command_push_flow.png)

客户端组件发布和上报运行实例

![运行实例](/assets/repo_push_cli_case.jpg)
